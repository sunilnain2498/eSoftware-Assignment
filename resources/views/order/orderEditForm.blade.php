                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('addNewOrder') }}" method="post" enctype="multipart/form-data" class="">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $product->price }}</td>
                                    <td>
                                        <a href="{{ route('removeProductOrder',['pid'=>$product->id,'oid'=>$order->id]) }}" class="btn btn-primary">Remove</a>
                                    </td>
                                </tr>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="total" id="total" value="{{ $order->total }}">
                        </div>
                         @error('address')
